...
<main>
    <div class="page-head">
      <div>
        ...
        <p class="subtitle">Crea una nueva cuenta de acceso al sistema</p>
      </div>
        ...
        <div class="grid cols-2">
          ...
          <label class="field">
            ...
            <select id="rol" name="rol" required>
              ...
              <option value="3">Recepcionista/Cajero</option>
          ...
          <div class="field full">
            <button type="submit" class="btn btn-amber">Registrar usuario</button>
          </div>
