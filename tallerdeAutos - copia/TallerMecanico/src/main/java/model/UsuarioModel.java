...
public class UsuarioModel implements UsuarioInterface{
	...
	public List<Usuario> listarUsuarios() {
		...
		try {
			...
			System.out.println("=== DEBUG URL: " + cn.getMetaData().getURL());       // DEBUG
	        System.out.println("=== DEBUG CATALOG: " + cn.getCatalog());              // DEBUG
			
			
			String sql = "select id, codigo, usuario, apellidos, nombres, celular, id_rol, estado FROM usuario";
