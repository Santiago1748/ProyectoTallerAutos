...
<title>Taller Fortuna — Listado de Usuarios</title>
...
<div class="list-container">
    ...
    <div class="table-responsive-wrapper">
        <table>
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td colspan="8" class="empty-row">No hay usuarios registrados.</td>
                </tr>
                <%
                    }
                %>
    ...
    <a href="mantenUsuarios.jsp" class="btn-new">+ Registrar nuevo usuario</a>
</div>
